                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MCC-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MCC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mcc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MCC Core"), this);
    aboutAction->setStatusTip(tr("Show information about MCC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MCC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MCC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MCC addresses"));
    ...
    openAction->setStatusTip(tr("Open a MCC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MCC Core help message to get a list with possible MCC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MCC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MCC network", "", count));
}
...
{
    QString strTitle = tr("MCC Core"); // default title
