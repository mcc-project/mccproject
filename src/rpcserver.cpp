...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MCC features */
        {"mcc", "masternode", &masternode, true, true, false},
        {"mcc", "masternodelist", &masternodelist, true, true, false},
        {"mcc", "mnbudget", &mnbudget, true, true, false},
        {"mcc", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"mcc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mcc", "mnsync", &mnsync, true, true, false},
        {"mcc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mccd, or the -server option to mcc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mcc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29869/\n";
}
