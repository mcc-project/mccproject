...
RESOURCES += src/qt/mcc.qrc src/qt/mcc_locale.qrc

TRANSLATIONS += src/qt/locale/mcc_bg.ts \
                src/qt/locale/mcc_de.ts \
                src/qt/locale/mcc_en.ts \
                src/qt/locale/mcc_es.ts \
                src/qt/locale/mcc_fi.ts \
                src/qt/locale/mcc_fr.ts \
                src/qt/locale/mcc_it.ts \
                src/qt/locale/mcc_ja.ts \
                src/qt/locale/mcc_pl.ts \
                src/qt/locale/mcc_pt.ts \
                src/qt/locale/mcc_ru.ts \
                src/qt/locale/mcc_sk.ts \
                src/qt/locale/mcc_sv.ts \
                src/qt/locale/mcc_vi.ts \
                src/qt/locale/mcc_zh_CN.ts \
                src/qt/locale/mcc_zh_TW.ts
